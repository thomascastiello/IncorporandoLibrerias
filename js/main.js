...
addToShoppingCartButtons.forEach(btn => {
    btn.addEventListener('click', addToShoppingCartButtons);
    btn.addEventListener('click', () =>{
        Toastify({
            text:"Agregaste una hamburguesa al carrito",
            duration: 3000,
            newWindow: true,
            close: false,
            ...
            style: {
              background: "linear-gradient(to right, #C70039, #581845 )",
            },
            offset: {
